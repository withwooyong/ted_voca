...
| `supabase/migrations/004_grammar.sql` | **신규** quiz_attempts 컬럼 추가 + 시드 (003은 P1+P2 리뷰 수정이 선점) |
...
- [x] migration 004 적용 SQL 생성 (컬럼+시드 토픽 20/문항 200) — 서버 적용은 Supabase 사용 시
- [x] `grammar.ts` 채점 로직 + 테스트
- [x] 콘텐츠 생성 스크립트 (1차 200문항 — human review는 잔여, HANDOFF 참조)
- [x] 퀴즈 3유형 화면 + 오답 해설
- [x] 문법 사전 목록/상세
- [x] quiz_attempts 기록 + XP/streak 연동
- [x] weak_tags → Ted 추천 노출
- [x] typecheck + 전체 테스트 PASS
