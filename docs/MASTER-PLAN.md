...
- [ ] 신규 사용자가 **5분 온보딩 + 20문항 레벨 테스트** 후 맞춤 코스 시작
- [ ] **어휘**: 빈칸/4지선다/철자 퀴즈 + 코스별 단어팩(토익·일상·수능 등)
- [ ] **SRS 복습**: SM-2 기반 자동 복습 큐 + "오늘의 복습" 푸시
- [ ] **문법**: 카드 배열/선택형 문법 퀴즈 + 오답 해설
- [ ] **리스닝**: 원어민 TTS 재생 → 따라 말하기(선택) → comprehension 퀴즈
- [ ] **회화/스피킹**: 상황별 대화 시나리오 + STT 입력 + LLM 피드백
- [ ] **게임화**: 일일 목표, streak, 간단 리그(주간 XP), 학습 통계 대시보드
- [ ] **오프라인**: 최근 학습 세션·단어팩 캐시 (지하철 등 네트워크 불안정 환경)
...
| **P1 Vocab Core** | 3주 | 레벨 테스트, 어휘 퀴즈, 토익 코스 | [p1-p2-vocab-srs.md](plans/p1-p2-vocab-srs.md) — P1+P2 통합 실행 |
| **P2 SRS + Stats** | 2주 | SM-2, 복습, streak/XP/통계 | ↑ (퀴즈 결과가 SRS 입력이라 통합) |
| **P3 Grammar** | 3주 | 문법 퀴즈 + 사전 60토픽 | [p3-grammar.md](plans/p3-grammar.md) — P4와 병행 가능 |
